"""
Você deve construir uma classe carro que vai possuir dois atributos compostos por outras duas classes:
...
A direção terá a responsabiliade de controlar a direção. Ela oferece os seguintes atributos:
